...
export default function Hero(props: { id: string }) {
    return (
        <div className="bg-secondary dark:bg-gray-900 dark:text-white flex items-center justify-center h-screen" id={props.id}>
            <div className="flex flex-col items-center lg:justify-normal lg:flex-row gap-5 lg:gap-10">
                <div className="flex flex-col items-start lg:items-end justify-center lg:pl-5 w-1/2">
                ...
                <div className="flex gap-6 rounded-2xl justify-start w-1/2 lg:w-1/3">
                        <Image
                            className="shadow-xl bg-white sm:p-7 rounded-md sm:w-2/3 lg:w-full"
